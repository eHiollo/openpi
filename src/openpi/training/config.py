...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(
            ...
            # Must match pi05_base checkpoint (32). Real A10 actions are 7-D; ModelTransformFactory pads to action_dim.
            action_dim=32,
            action_horizon=10,
            max_token_len=128,
        ),
        ...
        #weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
        weight_loader=weight_loaders.CheckpointWeightLoader("./checkpoints/pi05_a10_finetune/Reach_4_25_1/90000/params"),
